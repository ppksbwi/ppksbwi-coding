            ...
            <b-navbar>
                ...
                <b-navbar-nav>
                    ...
                    <b-nav-item-dropdown right
                        ...
                        <dropdown-tab title="Cart"
                            :tabs="['cart']"> </dropdown-tab>
                    ...
                    <b-nav-item-dropdown right
                        ...
                        no-caret>
                        <div slot="button-content">
                          <font-awesome-icon :icon="['fas', 'bell']" height="25px" width="25px"/>
                        </div>
                        <dropdown-tab title="Notification"
                            :tabs="['notification']"> </dropdown-tab>
                    ...
                    <b-nav-item-dropdown right
                        ...
                        <template slot="button-content">
                            <div class="d-flex text-right text-13">
                                <div class="d-none d-lg-flex  flex-column mr-1 avatar-description justify-content-center">
                                    ...
                                    <span class="text-navtop ">Anderson </span>
                        ...
                        <div class="ig-title-dropdown h6 d-flex align-items-begin justify-content-begin py-3 px-4">
                            <div> Hello, <strong> Anderson </strong> </div>
                        </div>
...
::v-deep .nav-item.inverse .nav-link.active {
...
::v-deep .navbar-collapse.collapse.show {
  position: absolute;
  top: 80px;
