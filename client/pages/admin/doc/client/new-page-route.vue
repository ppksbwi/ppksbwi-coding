...
-----| details.vue
        ...
        <p>
            ...
            http://pp-ksbwi.com:8000<strong>/user/details</strong> and view the contents of the created vue file. Remember that within the pages you can use any vue component available in the project.
        </p>
